...
/*
	...
	is used by my own character type macros to answer questions about the type
	of a character. It handles the full multinational character set, and lets me
	ask some questions that the standard "ctype" macros cannot ask.
 */
char	cinfo[256] = {
	_C,		_C,		_C,		_C,	/* 0x0X	*/
	_C,		_C,		_C,		_C,
