/*
    ...
    The routines in this file implement commands that work word at a time. There
    are all sorts of word mode commands. If I do any sentence and/or paragraph
...
/*
	Kill forward by "n" words. The rules for final status are now different. It
	is not considered an error to delete fewer words than you asked. This lets
	you say "kill lots of words" and have the command stop in a reasonable way
	when it hits the end of the buffer. Normally this is
*/
int
...
/*
	...
	say delete 5 words, and there are only 4 words left. I considered making the
	first call to "backchar" special, but decided that that would just be wierd.
